...
const meta: Meta<typeof BifrostGroupBookingSheetSequenceContentSummaryLineItem> = {
...
export default meta;
type Story = StoryObj<typeof BifrostGroupBookingSheetSequenceContentSummaryLineItem>;
