...
const mockFilledData: EventData = {
  ...
  visibility: 'PUBLIC',
  publicNotes: 'Annual summer fundraising gala with live music and silent auction.',
  privateNotes: 'VIP section needs extra security. Client requested specific wine selection.'
};
